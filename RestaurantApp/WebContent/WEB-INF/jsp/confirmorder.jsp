...
<label><b style=color:Black>Name:</b></label><b style=color:Blue >${list1 }</b>
    ...
    <b style=color:red> <center><h2>Your Order has been Submitted!!</h2></center></b>
    ...
    <div class="container py-2">
        ...
        <table class="table table-striped table-responsive-sm">
             ...
             <br>
              ...
              <form action="topayBill">
                    <input  type="hidden" name="emailid"  value=${list2}>
                    <input  type="hidden" name="id"  value=${list3}>
                   <h3>After Receving The Order Click To This button...</h3> <p align="center"> <button type="submit"  class="btn btn-primary">
                    		 To Pay Bill
                    	</button></p>
                    	</form>
    </div>
