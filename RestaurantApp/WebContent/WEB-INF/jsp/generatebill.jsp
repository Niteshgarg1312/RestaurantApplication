...
function printpage()
{
	...
	window.print();
	alert("finish the print!!");
	}
</script>
<body>
<b style=color:red> <center><h2>Original Customer Bill!!!</h2></center></b>
<br>
<br>
    ...
    <div class="container py-2">
        ...
        <table class="table table-striped table-responsive-sm">
             ...
             <center><b style=color:black><label>Total Payment Paid to the Receptionist:</label></b><b style=color:blue>${payment }</b><lablel>*Include all tax</lablel></center>
              <form action="paybill">
             <select class="input100" name="paymentMethod" id="paymentMethod"  required autofocus>
